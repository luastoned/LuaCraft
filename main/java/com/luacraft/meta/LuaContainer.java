...
public class LuaContainer {
	 ...
	 * Gets the maximum number of slots the container can hold
	 * @arguments nil
	 * @return [[Number]]:slots
	 */
	 ...
	 * Gets the maximum stack size that the container slot can hold
	 * @arguments nil
	 * @return [[Number]]:slots
	 */
	 ...
	 * @author Jake
	 * @function GetName
	 * Gets the customized name of the container
	 * @arguments nil
	 * @return [[String]]:name
	 */
	 ...
	 * @author Jake
	 * @function GetSlot
	 * Gets the item stack within the slot
	 * @arguments nil
	 ...
	 * @author Jake
	 * @function SetSlot
	 * Sets the item stack within the slot
	 ...
	 * Decrease the stack size of the item within the slot
	 ...
	 * Returns whether or not this item is allowed to be placed in the slot
	 * @arguments [[Number]]:slot, [[ItemStack]]:item
	 ...
	 * @author Jake
	 * @function GetAll
	 * Returns a table of all the items within the container
