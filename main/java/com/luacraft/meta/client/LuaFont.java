...
public class LuaFont
{
	 ...
	 * @author Jake
	 * @function GetSize
	 * Gets the width and height of a string of text with the given font
	 ...
	 * @author Jake
	 * @function GetWidth
	 * Gets the width of a string of text with the given font
	 * @arguments [[String]]:text
	 * @return [[Number]]:width
	 */
	 ...
	 * @author Jake
	 * @function GetHeight
	 * Gets the height of a string of text with the given font
	 * @arguments [[String]]:text
	 ...
	 * Draws wrapped text on the screen
