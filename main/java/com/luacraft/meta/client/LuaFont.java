...
public class LuaFont {
	public static JavaFunction __tostring = new JavaFunction() {
		public int invoke(LuaState l) {
			FontRenderer self = (FontRenderer) l.checkUserdata(1,
					FontRenderer.class, "Font");
	...
	/**
	 * @author Jake
	 * @function GetSize Gets the width and height of a string of text with the
	 *           given font
	...
	/**
	 * @author Jake
	 * @function GetWidth Gets the width of a string of text with the given font
	 * @arguments [[String]]:text
	 * @return [[Number]]:width
	 */
	...
	/**
	 * @author Jake
	 * @function GetHeight Gets the height of a string of text with the given
	 *           font
	 * @arguments [[String]]:text
	...
	/**
	 * @author Jake
	 * @function DrawText Draws text on the screen
	...
	public static JavaFunction DrawText = new JavaFunction() {
		public int invoke(LuaState l) {
			...
			if (l.checkBoolean(5, false))
				self.drawStringWithShadow(text, x, y,
						LuaLibSurface.drawColor.getRGB());
			else
	...
	/**
	 * @author Jake
	 * @function DrawTextWrapped Draws wrapped text on the screen
	...
	public static JavaFunction DrawTextWrapped = new JavaFunction() {
		public int invoke(LuaState l) {
			...
			self.drawSplitString(text, x, y, width,
					LuaLibSurface.drawColor.getRGB());
